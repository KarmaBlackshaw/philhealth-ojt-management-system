...
return array(
    ...
    'Home' => $baseDir . '/models/HomeModel.php',
    'Intern' => $baseDir . '/models/InternModel.php',
    ...
    'User' => $baseDir . '/models/UserModel.php',
    'default' => $baseDir . '/models/DefaultModel.php',
    'init' => $baseDir . '/models/init.php',
);
